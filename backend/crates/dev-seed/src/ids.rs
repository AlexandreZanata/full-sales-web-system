...
pub fn product_ids() -> [Uuid; 12] {
    [
        ...
        parse("01900001-0020-7000-8000-000000000005"),
        parse("01900001-0020-7000-8000-000000000006"),
        parse("01900001-0020-7000-8000-000000000007"),
        parse("01900001-0020-7000-8000-000000000008"),
        parse("01900001-0020-7000-8000-000000000009"),
        parse("01900001-0020-7000-8000-000000000010"),
        parse("01900001-0020-7000-8000-000000000011"),
        parse("01900001-0020-7000-8000-000000000012"),
    ]
}

pub fn product_image_file_ids() -> [Uuid; 12] {
    [
        parse("01900001-0021-7000-8000-000000000001"),
        parse("01900001-0021-7000-8000-000000000002"),
        parse("01900001-0021-7000-8000-000000000003"),
        parse("01900001-0021-7000-8000-000000000004"),
        parse("01900001-0021-7000-8000-000000000005"),
        parse("01900001-0021-7000-8000-000000000006"),
        parse("01900001-0021-7000-8000-000000000007"),
        parse("01900001-0021-7000-8000-000000000008"),
        parse("01900001-0021-7000-8000-000000000009"),
        parse("01900001-0021-7000-8000-000000000010"),
        parse("01900001-0021-7000-8000-000000000011"),
        parse("01900001-0021-7000-8000-000000000012"),
    ]
}

pub fn product_image_row_ids() -> [Uuid; 12] {
    [
        parse("01900001-0022-7000-8000-000000000001"),
        parse("01900001-0022-7000-8000-000000000002"),
        parse("01900001-0022-7000-8000-000000000003"),
        parse("01900001-0022-7000-8000-000000000004"),
        parse("01900001-0022-7000-8000-000000000005"),
        parse("01900001-0022-7000-8000-000000000006"),
        parse("01900001-0022-7000-8000-000000000007"),
        parse("01900001-0022-7000-8000-000000000008"),
        parse("01900001-0022-7000-8000-000000000009"),
        parse("01900001-0022-7000-8000-000000000010"),
        parse("01900001-0022-7000-8000-000000000011"),
        parse("01900001-0022-7000-8000-000000000012"),
    ]
}

pub fn category_image_file_ids() -> [Uuid; 5] {
    [
        ...
        parse("01900001-0016-7000-8000-000000000004"),
        parse("01900001-0016-7000-8000-000000000005"),
    ]
}

pub fn portal_banner_ids() -> [Uuid; 3] {
    [
        parse("01900001-0017-7000-8000-000000000001"),
        parse("01900001-0017-7000-8000-000000000002"),
        parse("01900001-0017-7000-8000-000000000003"),
    ]
}

pub fn portal_banner_file_ids() -> [Uuid; 3] {
    [
        parse("01900001-0018-7000-8000-000000000001"),
        parse("01900001-0018-7000-8000-000000000002"),
        parse("01900001-0018-7000-8000-000000000003"),
    ]
}

pub fn portal_promotion_file_ids() -> [Uuid; 2] {
    [
        parse("01900001-0024-7000-8000-000000000001"),
        parse("01900001-0024-7000-8000-000000000002"),
    ]
}
