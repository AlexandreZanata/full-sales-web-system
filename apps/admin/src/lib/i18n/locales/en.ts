...
export const en: Messages = {
  ...
  auth: {
    ...
    heroTitle: 'Smart management,',
    heroTitleAccent: 'real results.',
    heroDescription:
      'The complete platform to administer, analyze, and grow your operations with security and efficiency.',
    featureSecure: 'Secure',
    featureSecureDesc: 'Your data protected with advanced encryption.',
    featureComplete: 'Complete',
    featureCompleteDesc: 'Every tool you need in one place.',
    featureFast: 'Fast',
    featureFastDesc: 'Optimized performance for higher productivity.',
  },
  shell: {
    menu: 'Menu',
  ...
  forms: {
    fields: {
      ...
      contactPhone: 'WhatsApp / contact phone',
      publicCode: 'Catalog share code',
    ...
    placeholders: {
      ...
      searchCommerce: 'Search by name or CNPJ…',
    ...
    commerceSearch: {
      noMatches: 'No commerces match your search',
      clear: 'Clear',
    },
    sections: {
      address: 'Address',
    ...
    validation: {
      ...
      quantityAdjustment: 'Enter a positive quantity',
  ...
  users: {
    ...
    sellerProfile: {
      ...
      saving: 'Saving…',
      sharePathHint: 'Customers open: /s/{code}',
    },
    toast: {
  ...
  commerces: {
    ...
    detail: {
      ...
      reactivate: 'Reactivate commerce',
      deactivateDialog: {
    ...
    registrations: {
      title: 'Commerce registrations',
      description: 'Review seller-submitted commerces before they become active.',
      backToQueue: 'Back to registration queue',
      notFound: 'Registration not found',
      filterStatus: 'Filter by registration status',
      approve: 'Approve',
      reject: 'Reject',
      openCommerce: 'Open commerce',
      columns: {
        tradeName: 'Trade name',
        cnpj: 'CNPJ',
        status: 'Status',
      ...
      empty: {
        ...
        description: 'Seller submissions awaiting review will appear here.',
      },
      rejectDialog: {
        title: 'Reject registration',
        message: 'The seller will see this reason on their submission.',
    ...
    toast: {
      ...
      reactivated: 'Commerce reactivated',
  ...
  products: {
    ...
    stock: {
      ...
      emptyHint: 'No units available. Adjust stock to sell this product.',
    },
    toast: {
  ...
  settings: {
    ...
    banner: {
      pastDue:
        'Your subscription payment is past due. Update your payment method to restore full access.',
      suspended: 'Your account is suspended. Update billing to reactivate tenant services.',
      updatePayment: 'Update payment',
    },
    billing: {
      title: 'Subscription & billing',
      description: 'Platform subscription, invoices, and payment methods for your tenant.',
      plan: 'Current plan',
      renewal: 'Renews on',
      trialEnds: 'Trial ends in {days} days',
      upgrade: 'Request plan upgrade',
      invoices: 'Invoices',
      addCard: 'Add credit card',
      cardTokenHelp: 'Paste the creditCardToken from Asaas.js sandbox tokenization.',
      cardToken: 'Credit card token',
      attachCard: 'Save card',
      pixCopy: 'Open invoice PDF for PIX/boleto payment details when available.',
      noInvoices: 'No invoices yet.',
    },
    payments: {
      title: 'Online payments',
      description: 'Connect your Asaas account to accept PIX, card, and boleto on the portal.',
      starterLocked:
        'Online payments require a Pro plan or higher. Request an upgrade to connect Asaas.',
      connect: 'Connect Asaas',
      disconnect: 'Disconnect',
      apiKey: 'Asaas API key',
      testConnection: 'Test connection',
      enableOnline: 'Enable online payments',
      autoCapture: 'Auto-capture on checkout',
      methodPix: 'PIX',
    ...
    domains: {
      ...
      description: 'Attach a verified hostname for white-label portal access (Pro+).',
      add: 'Add domain',
      hostname: 'Hostname',
      verify: 'Check DNS',
      setPrimary: 'Set primary',
      dnsInstructions: 'Add TXT record {record} = {value}',
      noDomains: 'No custom domains configured.',
    },
  },
  portal: {
    title: 'Portal content',
    description: 'Manage storefront hero banners.',
    banners: 'Hero banners',
    promotions: 'Offer promotions',
    bannerImage: 'Banner image',
    bannerImageFileId: 'Banner image file ID',
    bannerImageUrl: 'Image URL (optional)',
    bannerLinkUrl: 'Click link (optional)',
    bannerPreview: 'Preview',
    addBanner: 'Add banner',
    promoHeadline: 'Headline',
    promoDiscount: 'Discount text',
    promoBackground: 'Background',
    promoCategorySlug: 'Category slug',
    addPromotion: 'Add promotion',
    featuredProduct: 'Featured on portal home',
    toast: {
      bannerCreated: 'Banner created',
      bannerDeleted: 'Banner removed',
      promotionCreated: 'Promotion created',
      promotionDeleted: 'Promotion removed',
    },
  },
  inventory: {
    hub: {
    ...
    adjustments: {
      ...
      directionIn: 'In',
      directionOut: 'Out',
      quantityHint: 'Enter how many units to add (In) or remove (Out).',
