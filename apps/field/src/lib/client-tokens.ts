...
const deliveryStatusColors: Record<DeliveryStatus, StatusToken> = {
...
export function getDeliveryStatusToken(status: string): StatusToken {
  if (status in deliveryStatusColors) {
