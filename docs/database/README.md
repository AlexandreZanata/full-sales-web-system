...
## Phase 13 additions (2026-07-04)

| Change | Migration |
|--------|-----------|
| `sales.order_id` nullable UUID (portal sales link to order) | `20260704123500` |
| Declared payment columns (`declared_payment_*`, RN-PAG1–RN-PAG3) | `20260704123500` |
| `payment_method` allows `NotDeclared` for order-born sales (DE-010) | `20260704123500` |
| Index `idx_sales_tenant_order` | `20260704123500` |

Domain crate delta: `Sale.from_delivery`, `Sale.declare_payment`, `PaymentDeclarationAuditPort`.  
Application: `confirm_delivery_and_create_sale`. Infra: `declare_payment` + audit in one TX.
